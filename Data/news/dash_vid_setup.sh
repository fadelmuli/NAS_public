...
function x264_encode() {
   ...
   ./x264-r3049-55d517b --output intermediate_${bitrate}k.264 --fps 24 --preset slow --bitrate ${bitrate} --vbv-maxrate $((bitrate * 2)) --vbv-bufsize $((bitrate * 4)) --min-keyint 96 --keyint 96 --scenecut 0 --no-scenecut --pass 1 --video-filter "resize:width=${width},height=${height},method=${method}" ${input_video}
